...
import tw.edu.ntub.imd.utils.bean.convert.LocalDateConverter;
import tw.edu.ntub.imd.utils.bean.convert.LocalDateTimeConverter;
import tw.edu.ntub.imd.utils.bean.convert.LocalTimeConverter;

import java.util.regex.Pattern;

public class BeanUtils {
    private static final CopyConverter<?, ?>[] converterArray;
    ...
    private static void copy(JavaBean source, JavaBean target, int copyPathIndex) throws ProjectException {
        // 遍歷source所有成員變數
                        ...
                        for (String name : targetDescriptor.getNameArray()) {
                            if (currentCopyToFieldName.equals(name)) {
                                if (isLast) {
                                    ...
                                    targetField.setValue(targetField.getJavaBean().getOriginalObject());
                                }
                                break;
                            }
                        }
    ...
    private static String[] getCopyToFieldNameArray(String copyToName) {
